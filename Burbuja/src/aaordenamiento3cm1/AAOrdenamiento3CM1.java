...
public class AAOrdenamiento3CM1 {
    ...
    public static void main(String[] args) {
        ...
        double [] datos =herramientas.Datos.generarDatosAleatorios(100000, 10000);
        ...
        b2.ordenar(datos);
        Grafica g = new Grafica("Gafica timpo","tiempo","iteraciones");
        g.agregarSerie(b1.getTiempos(), "Burbuja");
        g.agregarSerie(b2.getTiempos(), "Burbuja Optimizado");
